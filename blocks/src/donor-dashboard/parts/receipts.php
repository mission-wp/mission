...
$receipt_intro = apply_filters(
	...
	sprintf(
		...
		__( 'Download your annual donation receipts for tax purposes. %s — All donations are tax-deductible to the extent allowed by law.', 'missionwp-donation-platform' ),
...
<div class="mission-dd-panel" data-wp-class--active="state.isReceipts">
		...
		<template data-wp-each--receipt="context.receipts.years">
			<div class="mission-dd-receipt-row">
				<div class="mission-dd-receipt-year">
					...
					><?php esc_html_e( 'YTD', 'missionwp-donation-platform' ); ?></span>
				</div>
				<div class="mission-dd-receipt-summary">
					...
					printf(
						...
						esc_html__( 'from %s donations', 'missionwp-donation-platform' ),
				...
				<button
					...
					title="<?php esc_attr_e( 'Download annual receipt PDF', 'missionwp-donation-platform' ); ?>"
				>
					<span class="mission-dd-icon mission-dd-icon-download-sm" aria-hidden="true"></span>
					<?php esc_html_e( 'Download PDF', 'missionwp-donation-platform' ); ?>
				</button>
			</div>
		</template>
	</div>
	...
	<div class="mission-dd-empty" data-wp-bind--hidden="context.receipts.hasAny">
		<p><?php esc_html_e( 'No donation receipts available yet. Your annual receipts will appear here after your first donation.', 'missionwp-donation-platform' ); ?></p>
	</div>
