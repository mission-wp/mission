...
<h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a2e;">
	<?php esc_html_e( 'Verify your new email address', 'missionwp-donation-platform' ); ?>
</h1>
...
<p style="margin: 0 0 24px;">
	...
	printf(
		...
		esc_html__( 'You requested to change your email address to %s. Click the button below to confirm this change.', 'missionwp-donation-platform' ),
	...
	<tr>
		<td align="center">
			<a href="<?php echo esc_url( $data['verification_url'] ); ?>" style="display: inline-block; padding: 14px 32px; background-color: #2fa36b; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px; border-radius: 6px;">
				<?php esc_html_e( 'Verify new email address', 'missionwp-donation-platform' ); ?>
			</a>
		</td>
	</tr>
</table>
...
<p style="margin: 0 0 8px; color: #6b7280; font-size: 14px;">
	...
	printf(
		...
		esc_html__( 'This link expires in %s hours. If you didn\'t request this change, you can safely ignore this email.', 'missionwp-donation-platform' ),
