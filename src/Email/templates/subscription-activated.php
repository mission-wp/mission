...
<h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a2e;">
	<?php esc_html_e( 'Your recurring donation is active', 'missionwp-donation-platform' ); ?>
</h1>
...
<p style="margin: 0 0 16px;">
	<?php esc_html_e( 'Thank you for setting up a recurring donation! Here are your subscription details:', 'missionwp-donation-platform' ); ?>
</p>
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 20px 0; border: 1px solid #e5e7eb; border-radius: 8px;">
	...
	<tr>
		<td style="padding: 12px 16px; font-weight: 600;">
			<?php esc_html_e( 'Next payment', 'missionwp-donation-platform' ); ?>
		</td>
...
<p style="margin: 16px 0 0; color: #6b7280; font-size: 14px;">
	<?php esc_html_e( 'You will receive a receipt each time your donation is processed.', 'missionwp-donation-platform' ); ?>
</p>
