...
<h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a2e;">
	<?php esc_html_e( 'Recurring Donation Renewed', 'mission-donation-platform' ); ?>
</h1>
...
<p style="margin: 0 0 16px;">
	...
	printf(
		wp_kses(
			...
			__( '<strong>%1$s</strong>\'s %2$s recurring donation of <strong>%3$s</strong> has been renewed.', 'mission-donation-platform' ),
			[ 'strong' => [] ]
		),
