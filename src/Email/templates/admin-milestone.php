	...
	if ( $is_percentage ) {
		printf(
			wp_kses(
				...
				__( '<strong>%1$s</strong> has reached <strong>%2$s</strong> of its goal!', 'mission-donation-platform' ),
				[ 'strong' => [] ]
			),
		...
		printf(
			wp_kses(
				...
				__( '<strong>%s</strong> has received its first donation!', 'mission-donation-platform' ),
				[ 'strong' => [] ]
			),
			esc_html( $data['campaign_name'] )
		);
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 20px 0; border: 1px solid #e5e7eb; border-radius: 8px;">
	...
	<tr>
		<td style="padding: 12px 16px; border-bottom: 1px solid #e5e7eb; font-weight: 600;">
			<?php esc_html_e( 'Milestone', 'mission-donation-platform' ); ?>
		</td>
		<td style="padding: 12px 16px; border-bottom: 1px solid #e5e7eb;">
	...
	<tr>
		<td style="padding: 12px 16px; <?php echo ! empty( $data['goal_formatted'] ) ? 'border-bottom: 1px solid #e5e7eb; ' : ''; ?>font-weight: 600;">
			<?php esc_html_e( 'Total raised', 'mission-donation-platform' ); ?>
		</td>
	...
	<?php if ( ! empty( $data['goal_formatted'] ) ) : ?>
		<tr>
			<td style="padding: 12px 16px; font-weight: 600;">
				<?php esc_html_e( 'Goal', 'mission-donation-platform' ); ?>
			</td>
