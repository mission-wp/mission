...
<h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a2e;">
	<?php esc_html_e( 'Recurring Payment Failed', 'mission-donation-platform' ); ?>
</h1>
...
<p style="margin: 0 0 16px;">
	...
	printf(
		wp_kses(
			...
			__( 'A %1$s %2$s renewal payment from <strong>%3$s</strong> has failed.', 'mission-donation-platform' ),
			[ 'strong' => [] ]
		),
