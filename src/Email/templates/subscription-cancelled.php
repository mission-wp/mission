...
<h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a2e;">
	<?php esc_html_e( 'Subscription cancelled', 'mission' ); ?>
</h1>
...
<p style="margin: 0 0 16px;">
	...
	printf(
		...
		esc_html__( 'Your %1$s %2$s recurring donation has been cancelled.', 'mission' ),
...
<p style="margin: 0 0 16px;">
	<?php esc_html_e( 'No further payments will be processed. Thank you for your past support!', 'mission' ); ?>
</p>
...
<p style="margin: 16px 0 0; color: #6b7280; font-size: 14px;">
	...
	printf(
		...
		esc_html__( 'If you would like to start a new donation, please visit %s.', 'mission' ),
		esc_html( $site_name )
	);
	?>
</p>
