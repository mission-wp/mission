...
<p style="margin: 0 0 24px;">
	<?php esc_html_e( 'Click the button below to verify your email and set up your donor dashboard account. You\'ll be able to view your donation history, download tax receipts, and manage recurring gifts.', 'mission-donation-platform' ); ?>
</p>
	...
	<tr>
		<td align="center">
			<a href="<?php echo esc_url( $data['verification_url'] ); ?>" style="display: inline-block; padding: 14px 32px; background-color: #2fa36b; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px; border-radius: 6px;">
				<?php esc_html_e( 'Verify email address', 'mission-donation-platform' ); ?>
			</a>
		</td>
	</tr>
</table>
...
<p style="margin: 0 0 8px; color: #6b7280; font-size: 14px;">
	...
	printf(
		...
		esc_html__( 'This link expires in %s hours. If you didn\'t request this, you can safely ignore this email.', 'mission-donation-platform' ),
