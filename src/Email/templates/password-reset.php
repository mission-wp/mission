...
<p style="margin: 0 0 24px;">
	<?php esc_html_e( 'We received a request to reset the password on your donor account. Click the button below to choose a new password.', 'mission-donation-platform' ); ?>
</p>
	...
	<tr>
		<td align="center">
			<a href="<?php echo esc_url( $data['reset_url'] ); ?>" style="display: inline-block; padding: 14px 32px; background-color: #2fa36b; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px; border-radius: 6px;">
				<?php esc_html_e( 'Reset password', 'mission-donation-platform' ); ?>
			</a>
		</td>
	</tr>
</table>
...
<p style="margin: 0 0 8px; color: #6b7280; font-size: 14px;">
	...
	printf(
		...
		esc_html__( 'This link expires in %s hours. If you didn\'t request a password reset, you can safely ignore this email — your password will not be changed.', 'mission-donation-platform' ),
