...
<h1 style="margin: 0 0 20px; font-size: 24px; font-weight: 600; color: #1a1a2e;">
	<?php esc_html_e( 'Thank you for your donation', 'missionwp-donation-platform' ); ?>
</h1>
...
<p style="margin: 0 0 16px;">
	<?php esc_html_e( 'Your donation has been received successfully.', 'missionwp-donation-platform' ); ?>
</p>
...
<p style="margin: 16px 0 0; color: #6b7280; font-size: 14px;">
	<?php esc_html_e( 'Thank you for your generosity!', 'missionwp-donation-platform' ); ?>
</p>
