...
<p style="margin: 0 0 16px;">
	...
	printf(
		...
		esc_html__( 'We were unable to process your %1$s %2$s donation.', 'mission-donation-platform' ),
...
<p style="margin: 0 0 16px;">
	<?php esc_html_e( 'To keep your recurring donation active, please log in to your donor dashboard and update your payment method.', 'mission-donation-platform' ); ?>
</p>
