...
<div class="wp-block-column"><!-- wp:mission-donation-platform/top-donors {"campaignId":<?php echo (int) $campaign_id; ?>} /--></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:mission-donation-platform/recent-donors /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
